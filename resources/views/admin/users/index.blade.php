...
<div class="mb-8 flex items-center justify-between">
    <div>
        <h2 class="text-2xl font-extrabold text-slate-900 tracking-tight uppercase">Manajemen Admin Internal</h2>
        <p class="text-[10px] text-slate-400 font-bold uppercase tracking-[0.2em] mt-1">Kelola akun administrator pusat sistem</p>
    </div>
        ...
        <table class="w-full text-left">
            <thead>
                <tr class="bg-slate-50/50 border-b border-slate-100">
                    <th class="px-8 py-6 text-[10px] font-black text-slate-400 uppercase tracking-widest leading-loose">Informasi Admin</th>
                    <th class="px-8 py-6 text-[10px] font-black text-slate-400 uppercase tracking-widest">Akses</th>
...
<div id="userModal" class="fixed inset-0 z-[120] flex items-center justify-center hidden">
    ...
    <div class="relative bg-white rounded-[3rem] p-10 max-w-lg w-full mx-4 shadow-2xl animate-in fade-in zoom-in duration-300">
        ...
        <div class="mb-8">
            <h3 class="text-lg font-black text-slate-900 uppercase tracking-tight">Tambah Admin Pusat Baru</h3>
            <p class="text-[9px] text-slate-400 font-bold uppercase tracking-widest mt-1">Daftarkan akun administrator pusat baru untuk mengelola seluruh sistem.</p>
        </div>
