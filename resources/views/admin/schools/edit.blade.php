...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="bg-white rounded-[2.5rem] shadow-xl border border-slate-200/60 overflow-hidden transition-all duration-500 hover:shadow-2xl hover:shadow-slate-200/50">
        ...
        <div class="relative px-6 md:px-10 py-8 md:py-12 bg-slate-900">
            <!-- Decorative Background Elements -->
            <div class="absolute top-0 right-0 w-48 h-48 bg-indigo-500/10 rounded-full -mr-24 -mt-24 blur-3xl"></div>
            ...
            <div class="relative z-10 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6">
                <div class="flex items-center gap-4 md:gap-6">
                    <div class="w-12 h-12 md:w-16 md:h-16 bg-white/10 backdrop-blur-md rounded-2xl flex items-center justify-center text-white border border-white/20 shadow-xl shrink-0">
                    ...
                    <div>
                        <h2 class="text-xl md:text-2xl font-black text-white tracking-tight uppercase">Edit Profil</h2>
                        <p class="text-[9px] md:text-[10px] text-slate-400 font-bold uppercase tracking-[0.2em] mt-1 flex items-center gap-2">
                ...
                <a href="{{ url()->previous() }}" class="w-full sm:w-auto px-5 py-2.5 bg-white/5 hover:bg-white/10 text-white text-[10px] font-black uppercase tracking-widest rounded-xl border border-white/10 transition-all flex items-center justify-center gap-2">
        ...
        <form action="{{ route('schools.update', $school->id) }}" method="POST" enctype="multipart/form-data" class="bg-white">
            ...
            <div class="grid grid-cols-12">
                ...
                <!-- Left Sidebar: Assets Management -->
                <div class="col-span-12 lg:col-span-4 bg-slate-50/50 border-r border-slate-100 p-6 md:p-10 space-y-10">
                    <!-- section: Logo -->
                    <div class="space-y-5">
                        <div class="flex items-center justify-between">
                            <h3 class="text-[10px] font-black text-slate-500 uppercase tracking-widest flex items-center gap-3">
                        ...
                        <div class="relative group max-w-[200px] mx-auto lg:mx-0">
                            <div id="preview-box" class="aspect-square w-full bg-white rounded-3xl border-2 border-dashed {{ $school->logo ? 'border-indigo-200' : 'border-slate-200' }} flex flex-col items-center justify-center transition-all overflow-hidden relative shadow-sm {{ $isTrial ? 'opacity-70 bg-slate-50 cursor-not-allowed' : 'hover:border-indigo-400' }}">
                                @if($school->logo)
                                ...
                                @else
                                    <div id="preview-placeholder" class="text-center p-4">
                                        ...
                                        <p class="text-[8px] font-black text-slate-400 uppercase tracking-widest">Unggah Logo</p>
                                    </div>
                            ...
                            @if($isTrial)
                            <div class="absolute inset-x-0 -bottom-3 z-20 px-2">
                                <span class="w-full bg-slate-900 text-white text-[7px] font-black px-3 py-2 rounded-lg uppercase tracking-widest flex items-center justify-center gap-2 shadow-lg">
                    ...
                    <div class="space-y-5 border-t border-slate-100 pt-8">
                        ...
                        <div class="relative group max-w-[160px] mx-auto lg:mx-0">
                            <div id="bg-preview-box" class="aspect-[9/16] bg-white rounded-3xl border-2 border-dashed {{ $school->custom_background ? 'border-transparent' : 'border-slate-200' }} flex flex-col items-center justify-center transition-all overflow-hidden relative shadow-sm {{ !$isLifetime && strtolower(Auth::user()->role) !== 'superadmin' ? 'opacity-90 bg-slate-100' : 'hover:border-emerald-400' }}">
                                ...
                                @else
                                    <div id="bg-preview-placeholder" class="text-center p-4">
                                        <svg class="w-8 h-8 text-slate-300 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" /></svg>
                                        <p class="text-[8px] font-black text-slate-400 uppercase tracking-widest leading-tight">Unggah<br>Background</p>
                                    </div>
                            ...
                            <div class="absolute inset-x-0 -bottom-3 z-40 px-2">
                                <span class="w-full bg-slate-900 text-amber-400 text-[7px] font-black px-3 py-2 rounded-lg uppercase tracking-widest flex items-center justify-center gap-2 shadow-lg">
