        ...
        <form action="{{ route('schools.update', $school->id) }}" method="POST" enctype="multipart/form-data" class="p-4 md:p-8 lg:p-10">
            ...
            <div class="grid grid-cols-12 gap-8">
                ...
                <div class="col-span-12 lg:col-span-4 space-y-8">
                    <div>
                        <label class="block text-[9px] font-black text-slate-400 uppercase tracking-[0.2em] mb-4 text-left">Logo Instansi</label>
                        @php
                        ...
                        <div class="relative group">
                            <div id="preview-box" class="aspect-square w-full max-w-[160px] md:max-w-[240px] mx-auto lg:mx-0 bg-slate-50/50 rounded-[2rem] border-2 border-dashed {{ $school->logo ? 'border-indigo-100' : 'border-slate-200' }} flex flex-col items-center justify-center transition-all overflow-hidden relative shadow-inner {{ $isTrial ? 'opacity-70 bg-slate-100 cursor-not-allowed' : 'hover:bg-white hover:border-indigo-300' }}">
                                @if($school->logo)
                    ...
                    <div>
                        <div class="flex items-center justify-between mb-4 px-1">
                            <label class="block text-[9px] font-black text-slate-400 uppercase tracking-[0.2em] text-left">Custom Background App</label>
                            @if($isLifetime)
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <textarea name="address" rows="2" placeholder="Jl. Jenderal Sudirman No..."
                                class="w-full bg-white md:bg-slate-50 border border-slate-100 py-3.5 px-6 rounded-xl font-bold text-slate-900 text-sm outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition shadow-inner resize-none text-left">{{ old('address', $school->address) }}</textarea>
                        </div>
                    </div>
                </div>
            </div>

            <div class="mt-8 md:mt-12 pt-8 md:pt-10 border-t border-slate-100 bg-slate-50/30 md:bg-transparent -mx-6 md:mx-0 px-6 md:px-0 rounded-3xl md:rounded-none">
            ...
            <!-- Branding & Web Access -->
            <div class="mt-8 md:mt-12 pt-8 md:pt-10 border-t border-slate-100 bg-emerald-50/10 md:bg-transparent -mx-6 md:mx-0 px-6 md:px-0 rounded-3xl md:rounded-none">
                <div class="flex items-center gap-4 mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pb-6 md:pb-0">
