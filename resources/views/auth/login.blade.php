        ...
        <div class="w-full max-w-[440px] rounded-[2rem] bg-white shadow-premium overflow-hidden border border-white">
            ...
            <div class="px-10 pb-12">
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <a href="{{ route('google.login') }}" class="w-full group flex items-center justify-center gap-3 rounded-2xl border-2 border-slate-100 bg-white py-4 px-6 transition-all hover:bg-slate-50 hover:border-slate-200 active:scale-[0.98] shadow-sm">
