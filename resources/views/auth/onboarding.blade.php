...
<head>
    ...
    <title>Setup Profil | Schola Exambro</title>
                ...
                <div class="mb-6 md:mb-8 text-left">
                    <div class="flex items-center gap-4 mb-6 md:mb-8">
                        ...
                        <div class="border-l border-slate-200 dark:border-slate-700 pl-4">
                            <h2 class="text-base md:text-lg font-black text-slate-800 dark:text-white uppercase tracking-tighter leading-none whitespace-nowrap">Schola <span class="text-blue-600 italic">Exambro</span></h2>
                        ...
                        <div class="space-y-1">
                            ...
                            <div class="mt-1 flex flex-wrap gap-x-2 gap-y-1 ml-6">
                                <span class="text-[8px] font-bold text-slate-400 uppercase tracking-widest flex items-center gap-1">
                                    <span class="w-1 h-1 bg-blue-500 rounded-full"></span> 8+ Karakter
                                </span>
                                <span class="text-[8px] font-bold text-slate-400 uppercase tracking-widest flex items-center gap-1">
                                    <span class="w-1 h-1 bg-blue-500 rounded-full"></span> Mix Huruf, Angka & Simbol
                                </span>
                            </div>
