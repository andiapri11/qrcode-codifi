...
<head>
    ...
    <title>Pusat Bantuan | Schola CBT</title>
    ...
    <main class="max-w-4xl mx-auto px-6 py-12 md:py-20">
        ...
        <section class="grid md:grid-cols-2 gap-8">
            ...
            <div class="glass-card p-8 rounded-3xl">
                ...
                <p class="text-slate-500 dark:text-slate-400 leading-relaxed">Schola CBT menggunakan enkripsi tingkat militer dan backup harian untuk memastikan semua data ujian dan siswa tetap aman.</p>
            </div>
        </section>
