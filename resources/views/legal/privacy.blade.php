...
<body class="bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-100 min-h-screen transition-colors duration-300">
    ...
    <main class="max-w-4xl mx-auto px-6 py-16 prose">
        ...
        <section>
            ...
            <p>Kami mengumpulkan informasi yang Anda berikan langsung kepada kami saat mendaftarkan instansi, seperti nama admin, alamat email, dan nama instansi pendidikan.</p>
            
            <h2>2. Penggunaan Data</h2>
            <p>Data Anda digunakan untuk memproses akun, memberikan layanan ujian digital, dan meningkatkan keamanan sistem CBT kami.</p>
