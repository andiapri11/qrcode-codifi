    ...
    <nav class="fixed top-0 w-full z-50 glass border-b border-white/50 transition-all duration-300">
        <div class="max-w-screen-2xl mx-auto px-6 lg:px-10 h-16 lg:h-24 flex items-center justify-between">
            ...
            <div class="hidden lg:flex items-center gap-1">
                ...
                <a href="{{ route('public.download') }}" class="px-5 py-2.5 rounded-xl text-[10px] font-black text-indigo-600 hover:text-indigo-700 hover:bg-slate-100 uppercase tracking-[0.2em] transition-all">Download Aplikasi</a>
        ...
        <div id="mobile-menu" class="hidden lg:hidden bg-white border-t border-slate-100 p-6 animate-in slide-in-from-top duration-300">
            <div class="flex flex-col gap-5">
                ...
                <a href="{{ route('public.download') }}" onclick="toggleMobileMenu()" class="block px-6 py-4 text-[10px] font-black text-indigo-600 uppercase tracking-widest hover:text-indigo-700 border-b border-slate-50">Download Aplikasi</a>
